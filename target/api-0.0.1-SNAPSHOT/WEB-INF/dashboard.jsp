		...
		<div class="mt-2 mx-4 mb-3 text-center nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="m-1 nav-item"><a class="nav-link disabled" href="/dashboard">DASHBOARD </a></li>
...
<%-- <div class="card container d-flex col-12 mx-auto justify-content-between bg-transparent mt-4 mb-2 p-4">
	...
	<div class="p-4 m-4 table table-hover">
		<table class=" table table-hover">
			...
			<c:forEach items="${property}" var="properties">
				<tr>
					...
					<td class="align-middle">$ ${ properties.priceDescription } </td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
