	...
	<div class="card container mt-4 mb-4 p-4 bg-transparent">
		...
		<div class="my-3 row align-items-center">
			...
			<div class="d-flex btn-group-sm col-9 mt-3 my-2">
				<a href="/property/${ property.id}/ratings" class="btn btn-outline-primary shimmer-btn shimmer-btn:hover mx-2">Rate & Comment</a> 
				<a href="/property/${ property.id }/edit" class="btn btn-outline-primary shimmer-btn shimmer-btn:hover mx-2">Edit Rental</a>
